...
As a result of these tests:
 - no video play option on chrome in windows fixed and video position adjusted - introduced 'control' and changed padding. 

 - cards on right on iPhone6/7/8/X chrome &/ firefox simulation
 - cards slightly to right on iPhone6/7/8+ pixel 2XL chrome simulation
 - To correct these I removed an 80%container width media query 

- improved align on iphone XL with solution from
https://stackoverflow.com/questions/6072154/html-css-wrapper-is-not-center-aligned-in-iphone-safari

An outstanding issue remains that: 
...
### Acknowledgements
 ...
 - The pure HTML and CSS crossword was modified from that of Adrian Roworth available [here](https://codepen.io/adrianroworth/pen/OpeyZq)
...
### Future
 ...
 - - The modal quiz does not work on some older iPads 
